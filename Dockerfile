...
#Prometheus
RUN wget -O - https://github.com/prometheus/prometheus/releases/download/v1.3.0/prometheus-1.3.0.linux-amd64.tar.gz | tar zxv
...
#Alertmanager
RUN wget -O - https://github.com/prometheus/alertmanager/releases/download/v0.5.0/alertmanager-0.5.0.linux-amd64.tar.gz | tar zx
